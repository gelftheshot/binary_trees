 ...
 *
 * Description: This function finds the uncle of a node in a binary tree.
 * An uncle is the sibling of a node's parent. If the node is NULL
 * is NULL, or the node has no uncle, the function returns NULL.
 *
