...
/**
 * total_height - helper function to calculate the total height of a binary tree
 * @tree: pointer to the root node of the tree to measure the height
 *
 * Description: This function recursively calculates the total height of a binary tree.
 * It does this by calculating the height of the left and right subtrees and returning
 ...
 * @tree: pointer to the root node of the tree to measure the height
 *
 * Description: This function uses the helper function 'total_height' to calculate
 * the total height of the binary tree, and then subtracts one to get the height
 * as defined by the number of edges in the longest path from root to a leaf.
 *
